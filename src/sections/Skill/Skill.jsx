          ...
          <div className="row">
            ...
            <div className="col-md-12 col-lg-6">
              <div className="skill-progress wow animated slideInRight">
                <LinearProgressWithLabel label={"JAVASCRIPT"} value={90} />
                <LinearProgressWithLabel label={"REACTJS"} value={95} />
                <LinearProgressWithLabel label={"PHP"} value={85} />
                <LinearProgressWithLabel label={"LARAVEL"} value={90} />
                <LinearProgressWithLabel label={"Wordpress"} value={80} />
              </div>
            </div>
          </div>
        </div>

              ...
              <Slider {...settings}>
                <div className="member_feedback p_30 color_secondery">
                  <div className="client_img">
                    <img src="images/testimonial/01.jpg" alt="client" />
                  </div>
                ...
                <div className="member_feedback p_30 color_secondery">
                  <div className="client_img">
                    <img src="images/testimonial/02.jpg" alt="client" />
                  </div>
                  <div className="star d-inline-block mt_30 color_default">
                    <ul>
                      <li>
                ...
                <div className="member_feedback p_30 color_secondery">
                  <div className="client_img">
                    <img src="images/testimonial/03.jpg" alt="client" />
                  </div>
                  <div className="star d-inline-block mt_30 color_default">
                    <ul>
                      <li>
                ...
                <div className="member_feedback p_30 color_secondery">
                  <div className="client_img">
                    <img src="images/testimonial/04.jpg" alt="client" />
                  </div>
                  <div className="star d-inline-block mt_30 color_default">
                    <ul>
                      <li>
